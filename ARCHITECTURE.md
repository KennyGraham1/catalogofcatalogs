...
- [2. Catalogue Upload Data Flow](#2-catalogue-upload-data-flow)
- [3. React Component Hierarchy](#3-react-component-hierarchy)
- [4. Database Schema](#4-database-schema)
- [5. File Parsing Pipeline](#5-file-parsing-pipeline)
...
### VS Code
Install the [Markdown Preview Mermaid Support](https://marketplace.visualstudio.com/items?itemName=bierner.markdown-mermaid) extension to render diagrams in the Markdown preview.

### Mermaid Live Editor
Copy any diagram code to the [Mermaid Live Editor](https://mermaid.live/) to view, edit, and export diagrams.

### Command Line
Use [mermaid-cli](https://github.com/mermaid-js/mermaid-cli) to render diagrams to PNG/SVG:
```bash

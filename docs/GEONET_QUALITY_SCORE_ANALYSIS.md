...
| Aspect | Our System | GeoNet QS |
|--------|-----------|-----------|
| **Scale** | 0-100 continuous | QS0-QS6 discrete |
| **Grades** | A+, A, B, C, D, F | QS6, QS5, ..., QS0 |
| **Complexity** | High (5 components, weighted) | Medium (6-7 criteria) |
| **Standardization** | Custom | Published research |
| **Granularity** | Very fine (101 levels) | Coarse (7 levels) |
| **Communication** | Technical | Simple & clear |
| **Comparability** | Internal only | Comparable to GeoNet catalogue |

...
Publication-ready inventory of **107 distinct earthquake catalogues** developed for / covering
Aotearoa New Zealand (1960–2026, with emphasis on temporary deployments), each profiled to the
...
| File | Description |
|---|---|
| `nz_earthquake_catalogues_1960-2026.pdf` | Compiled report (103 pp): abstract, methods, overview, timeline, statistics, master index, 107 detailed entries across 10 categories, references. |
| `nz_earthquake_catalogues_1960-2026.tex` | LaTeX source (article class, `natbib` numeric, `xurl`). |
| `nz_catalogues.bib` | BibTeX database (163 references; `@article`/`@misc`/`@techreport`). |
